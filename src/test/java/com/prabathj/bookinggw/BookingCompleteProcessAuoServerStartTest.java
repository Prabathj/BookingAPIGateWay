...
import com.prabathj.bookingsrv.BookingService;
import com.prabathj.hotelavailabilitysrv.AvailabilityService;
...
public class BookingCompleteProcessAuoServerStartTest {
    ...
    public static void startup() {
    	AppServer.main(null);
    	BookingService.main(null);
    	AvailabilityService.main(null);
